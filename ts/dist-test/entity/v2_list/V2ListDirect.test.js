...
(0, node_test_1.describe)('V2ListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-v2_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v2_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FREE_MUSIC_TEST_V2_LIST_ENTID'];
...
//# sourceMappingURL=V2ListDirect.test.js.map