...
(0, node_test_1.describe)('V1ListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-v1_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v1_list', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-v1_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-v1_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["api_key01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FREE_MUSIC_TEST_V1_LIST_ENTID'];
...
//# sourceMappingURL=V1ListDirect.test.js.map