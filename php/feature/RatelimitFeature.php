...
// FreeMusic SDK ratelimit feature
...
class FreeMusicRatelimitFeature extends FreeMusicBaseFeature
{
    ...
    private function _acquire(FreeMusicContext $ctx): void
    {
    ...
    private function _track(FreeMusicContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
