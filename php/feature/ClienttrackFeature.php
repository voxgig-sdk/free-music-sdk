...
// FreeMusic SDK clienttrack feature
...
class FreeMusicClienttrackFeature extends FreeMusicBaseFeature
{
    ...
    public function PostConstruct(FreeMusicContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeMusic-SDK';
