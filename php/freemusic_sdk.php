...
class FreeMusicSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = FreeMusicHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = FreeMusicHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!FreeMusicFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, FreeMusicFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return FreeMusicUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = FreeMusicHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = FreeMusicHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = FreeMusicHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new FreeMusicError($op . "_allow",
                "FreeMusicSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = FreeMusicHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new FreeMusicError("graphql_error",
                "FreeMusicSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function V1List($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v1_list === null) {
                $this->_v1_list = new V1ListEntity($this, null);
            }
            return $this->_v1_list;
        }
        return new V1ListEntity($this, $data);
    }
    ...
    public function V1Lookup($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v1_lookup === null) {
                $this->_v1_lookup = new V1LookupEntity($this, null);
            }
            return $this->_v1_lookup;
        }
        return new V1LookupEntity($this, $data);
    }
    ...
    public function V1Search($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v1_search === null) {
                $this->_v1_search = new V1SearchEntity($this, null);
            }
            return $this->_v1_search;
        }
        return new V1SearchEntity($this, $data);
    }
    ...
    public function V2List($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v2_list === null) {
                $this->_v2_list = new V2ListEntity($this, null);
            }
            return $this->_v2_list;
        }
        return new V2ListEntity($this, $data);
    }
    ...
    public function V2Lookup($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v2_lookup === null) {
                $this->_v2_lookup = new V2LookupEntity($this, null);
            }
            return $this->_v2_lookup;
        }
        return new V2LookupEntity($this, $data);
    }
    ...
    public function V2Search($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_v2_search === null) {
                $this->_v2_search = new V2SearchEntity($this, null);
            }
            return $this->_v2_search;
        }
        return new V2SearchEntity($this, $data);
    }
