...
class FreeMusicFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeMusicSDK/1.0)';
    ...
    public static function call(FreeMusicContext $ctx, string $fullurl, array $fetchdef): array
    {
