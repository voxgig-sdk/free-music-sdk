...
class V1ListEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        [$v1_list_ref01_list_result, $err] = $v1_list_ref01_ent->list($v1_list_ref01_match, null);
        $this->assertNull($err);
        $this->assertIsArray($v1_list_ref01_list_result);

        // LOAD
        $v1_list_ref01_match_dt0 = [];
        [$v1_list_ref01_data_dt0_loaded, $err] = $v1_list_ref01_ent->load($v1_list_ref01_match_dt0, null);
        $this->assertNull($err);
