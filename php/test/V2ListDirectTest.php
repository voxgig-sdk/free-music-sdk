...
class V2ListDirectTest extends TestCase
{
    public function test_direct_load_v2_list(): void
    {
        $setup = v2_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v2_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
