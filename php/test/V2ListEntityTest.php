...
class V2ListEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREE_MUSIC_TEST_V2_LIST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $v2_list_ref01_data_dt0_loaded = $v2_list_ref01_ent->load($v2_list_ref01_match_dt0, null);
...
function v2_list_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREE_MUSIC_TEST_V2_LIST_ENTID");
