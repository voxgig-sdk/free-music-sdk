...
class V2LookupDirectTest extends TestCase
{
    public function test_direct_load_v2_lookup(): void
    {
        $setup = v2_lookup_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v2_lookup", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
