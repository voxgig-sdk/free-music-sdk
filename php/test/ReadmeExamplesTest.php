...
// FreeMusic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeMusicSDK::test)
...
{
    private const SDK_CLASS = 'FreeMusicSDK';
    ...
    private const SDK_BASE = 'freemusic_sdk';
