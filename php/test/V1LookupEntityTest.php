...
class V1LookupEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREEMUSIC_TEST_V__LOOKUP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function v1_lookup_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREEMUSIC_TEST_V__LOOKUP_ENTID");
