...
class FreeMusicTestRunner
{
    ...
    {
        $live = self::getenv('FREE_MUSIC_TEST_LIVE');
        $override = self::getenv('FREE_MUSIC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREE_MUSIC_TEST_EXPLAIN');
...
class_alias('FreeMusicTestRunner', 'Runner');
class_alias('FreeMusicHelpers', 'Helpers');
