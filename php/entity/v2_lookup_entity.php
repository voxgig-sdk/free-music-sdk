...
class V2LookupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V2LookupEntity($this->_client, $opts);
    }

    /**
     * @param V2Lookup|array $args V2Lookup data (assoc-array) to store.
     */
    ...
    /**
     * @return V2Lookup|array The current V2Lookup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V2Lookup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V2Lookup fields).
     */
    ...
    /**
     * Load a single V2Lookup.
     *
     * @param V2LookupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V2LookupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V2Lookup|array The loaded V2Lookup as an assoc-array at the
