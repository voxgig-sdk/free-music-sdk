...
class V2ListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V2ListEntity($this->_client, $opts);
    }

    /**
     * @param V2List|array $args V2List data (assoc-array) to store.
     */
    ...
    /**
     * @return V2List|array The current V2List data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V2List fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V2List fields).
     */
    ...
    /**
     * Load a single V2List.
     *
     * @param V2ListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V2ListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V2List|array The loaded V2List as an assoc-array at the
