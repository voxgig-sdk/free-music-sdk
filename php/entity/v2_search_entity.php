...
class V2SearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V2SearchEntity($this->_client, $opts);
    }

    /**
     * @param V2Search|array $args V2Search data (assoc-array) to store.
     */
    ...
    /**
     * @return V2Search|array The current V2Search data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V2Search fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V2Search fields).
     */
     ...
     *
     * @param V2SearchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V2SearchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V2Search|array The loaded V2Search as an assoc-array at the
