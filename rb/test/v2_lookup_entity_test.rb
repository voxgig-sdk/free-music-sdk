...
class V2LookupEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREE_MUSIC_TEST_V2_LOOKUP_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    v2_lookup_ref01_data_dt0_loaded = v2_lookup_ref01_ent.load(v2_lookup_ref01_match_dt0, nil)
...
def v2_lookup_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREE_MUSIC_TEST_V2_LOOKUP_ENTID"]
