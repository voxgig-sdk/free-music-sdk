...
class V1ListEntity
  ...
  #   as an empty match, so client.V1List.load works with no args).
  ...
  #
  # @param reqmatch [V1ListListMatch, Hash, nil] match filter (any subset of
  #   V1List fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
