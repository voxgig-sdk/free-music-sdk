...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FreeMusicOmni.make_runner(TEST_JSON_FILE, FreeMusicSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FreeMusicOmni.errify(err)
    end
