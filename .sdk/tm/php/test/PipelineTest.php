...
{
    private static function utility(): FreeMusicUtility
    {
        return new FreeMusicUtility();
    }
    ...
    private static function ctx(array $over = []): FreeMusicContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeMusicContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeMusicOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeMusicError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeMusicOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeMusicMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeMusicOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeMusicMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeMusicOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeMusicMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeMusicSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeMusicMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeMusicResponse([]),
            'result' => new FreeMusicResult([]),
        ]);
        [, $err] = FreeMusicMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeMusicSpec([]),
            'response' => null,
            'result' => new FreeMusicResult([]),
        ]);
        [, $err] = FreeMusicMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeMusicSpec(['step' => 's']),
            'response' => new FreeMusicResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeMusicResult([]),
        ]);
        [, $err] = FreeMusicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeMusicSpec(['step' => 's']),
            'response' => new FreeMusicResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeMusicResult([]),
        ]);
        [, $err] = FreeMusicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeMusicSpec(['step' => 's']),
            'response' => new FreeMusicResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeMusicResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeMusicMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeMusicResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeMusicSpec([]),
            'response' => new FreeMusicResponse([]),
            'result' => new FreeMusicResult([]),
        ...
        [$got, $err] = FreeMusicMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeMusicResult([])]);
        [, $err] = FreeMusicMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeMusicSpec([]), 'result' => null]);
        [, $err] = FreeMusicMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeMusicSpec(['step' => 's']),
            'result' => new FreeMusicResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeMusicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeMusicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeMusicSpec(['step' => 's']),
            'result' => new FreeMusicResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeMusicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeMusicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeMusicResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeMusicSpec([]),
            'result' => new FreeMusicResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeMusicMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeMusicMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeMusicError('boom', 'boom');
        $utility->fetcher = function (FreeMusicContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeMusicSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeMusicMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeMusicContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeMusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeMusicResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeMusicContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeMusicSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeMusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeMusicResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeMusicSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeMusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeMusicMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeMusicMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeMusicResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeMusicDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeMusicResult(['ok' => false])]);
        $this->expectException(FreeMusicError::class);
        FreeMusicDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeMusicResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeMusicMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeMusicMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeMusicBaseFeature();
        $b = new FreeMusicBaseFeature();
        FreeMusicFeatureAdd::call($ctx, $a);
        FreeMusicFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeMusicBaseFeature
    {
        $f = new FreeMusicBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeMusicFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeMusicContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeMusicSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeMusicPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeMusicResponse(['headers' => null]),
            'result' => new FreeMusicResult([]),
        ]);
        FreeMusicResultHeaders::call($ctx);
