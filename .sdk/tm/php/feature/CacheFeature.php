...
class FreeMusicCacheFeature extends FreeMusicBaseFeature
{
    ...
    private function _through(FreeMusicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
