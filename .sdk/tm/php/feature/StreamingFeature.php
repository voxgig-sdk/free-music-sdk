...
// FreeMusic SDK streaming feature
...
class FreeMusicStreamingFeature extends FreeMusicBaseFeature
{
    ...
    private function _iterate(FreeMusicResult $result): \Generator
    {
    ...
    private function _streamable(FreeMusicContext $ctx): bool
    {
