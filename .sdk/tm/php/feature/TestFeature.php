...
// FreeMusic SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeMusicTestFeature extends FreeMusicBaseFeature
{
    ...
    public function init(FreeMusicContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeMusicContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FreeMusicParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeMusicContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeMusicContext $ctx, $op, $args): array
    {
