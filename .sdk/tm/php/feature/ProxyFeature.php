...
class FreeMusicProxyFeature extends FreeMusicBaseFeature
{
    ...
    public function init(FreeMusicContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeMusicContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
