...
class FreeMusicRbacFeature extends FreeMusicBaseFeature
{
    ...
    private function _required(FreeMusicContext $ctx): ?string
    {
    ...
    private function _reject(FreeMusicContext $ctx, string $required): void
    {
    ...
    private function _track(FreeMusicContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
