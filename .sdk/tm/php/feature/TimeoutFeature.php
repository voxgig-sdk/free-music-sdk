...
class FreeMusicTimeoutFeature extends FreeMusicBaseFeature
{
    ...
    private function _with_timeout(FreeMusicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeMusicContext $_ctx, float $ms): void
    {
        $client = $this->client;
