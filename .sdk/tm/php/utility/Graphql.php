...
class FreeMusicGraphql
{
    ...
    // equivalent.
    public static function body(FreeMusicContext $ctx): mixed
    {
    ...
    public static function errors(FreeMusicContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
