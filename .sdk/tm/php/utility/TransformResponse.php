...
// FreeMusic SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeMusicTransformResponse
{
    public static function call(FreeMusicContext $ctx): mixed
    {
        ...
        $transform = FreeMusicHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
