...
from projectname_sdk import FreeMusicSDK
from projectname_sdk.core.spec import FreeMusicSpec
from projectname_sdk.core.result import FreeMusicResult
from projectname_sdk.core.response import FreeMusicResponse
from projectname_sdk.core.operation import FreeMusicOperation
from projectname_sdk.core.error import FreeMusicError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreeMusicBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FreeMusicError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreeMusicSDK.test(None, None)
        ...
        class TestInitFeature(FreeMusicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeMusicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeMusicSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeMusicSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeMusicSDK.test(None, setup_opts)
