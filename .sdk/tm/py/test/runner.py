...
class FreeMusicTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMusicTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeMusicTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeMusicTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
