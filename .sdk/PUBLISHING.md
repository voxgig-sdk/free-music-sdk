...
|---|---|---|
| `ts/` | @voxgig-sdk/free-music-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-music-sdk \
      --repository voxgig-sdk/free-music-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-music-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-music-sdk --id=<id>` removes it.
