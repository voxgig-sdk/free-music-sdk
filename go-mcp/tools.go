...
type Args struct {
	Entity string         `json:"entity" jsonschema:"v1_list | v1_lookup | v1_search | v2_list | v2_lookup | v2_search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeMusicSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-music_list",
		Description: "List records from FreeMusic. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-music_load",
		Description: "Load a single record from FreeMusic. " +
...
func runOp(client *sdk.FreeMusicSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeMusicSDK, name string) (sdk.FreeMusicEntity, error) {
	switch strings.ToLower(name) {
	case "v1_list":
		return client.V1List(nil), nil
	case "v1_lookup":
		return client.V1Lookup(nil), nil
	case "v1_search":
		return client.V1Search(nil), nil
	case "v2_list":
		return client.V2List(nil), nil
	case "v2_lookup":
		return client.V2Lookup(nil), nil
	case "v2_search":
		return client.V2Search(nil), nil
