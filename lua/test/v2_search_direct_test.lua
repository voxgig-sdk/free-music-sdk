...
describe("V2SearchDirect", function()
  it("should direct-load-v2_search", function()
    local setup = v2_search_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v2_search", setup.live and "live" or "unit")
...
function v2_search_direct_setup(mockres)
