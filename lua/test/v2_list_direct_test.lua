...
describe("V2ListDirect", function()
  it("should direct-load-v2_list", function()
    local setup = v2_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v2_list", setup.live and "live" or "unit")
...
function v2_list_direct_setup(mockres)
