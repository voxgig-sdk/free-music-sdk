...
describe("V2LookupDirect", function()
  it("should direct-load-v2_lookup", function()
    local setup = v2_lookup_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v2_lookup", setup.live and "live" or "unit")
...
function v2_lookup_direct_setup(mockres)
