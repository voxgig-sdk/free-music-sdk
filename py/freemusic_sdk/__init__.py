...
from freemusic_sdk.utility import register

# Load features
from freemusic_sdk.feature.base_feature import FreeMusicBaseFeature
from freemusic_sdk.features import _has_feature, _make_feature
...
class FreeMusicSDK:
    ...
    def get_utility(self):
        return FreeMusicUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeMusicSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def V1List(self, data=None) -> "V1ListEntity":
        ...
        from freemusic_sdk.entity.v1_list_entity import V1ListEntity
    ...
    def V1Lookup(self, data=None) -> "V1LookupEntity":
        ...
        from freemusic_sdk.entity.v1_lookup_entity import V1LookupEntity
    ...
    def V1Search(self, data=None) -> "V1SearchEntity":
        ...
        from freemusic_sdk.entity.v1_search_entity import V1SearchEntity
    ...
    def V2List(self, data=None) -> "V2ListEntity":
        ...
        from freemusic_sdk.entity.v2_list_entity import V2ListEntity
    ...
    def V2Lookup(self, data=None) -> "V2LookupEntity":
        ...
        from freemusic_sdk.entity.v2_lookup_entity import V2LookupEntity
    ...
    def V2Search(self, data=None) -> "V2SearchEntity":
        ...
        from freemusic_sdk.entity.v2_search_entity import V2SearchEntity
