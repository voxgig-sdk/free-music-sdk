...
from freemusic_sdk.freemusic_types import (
    V1List,
    V1ListLoadMatch,
    V1ListListMatch,
)
...
class V1ListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return V1ListEntity(self._client, opts)
    ...
    def load(self, reqmatch=None, ctrl=None) -> V1List:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.V1List().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[V1List]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.V1List().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
