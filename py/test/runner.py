...
class FreeMusicTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMusicTestRunner.getenv("FREEMUSIC_TEST_LIVE")
        override = FreeMusicTestRunner.getenv("FREEMUSIC_TEST_OVERRIDE")
        ...
        explain = FreeMusicTestRunner.getenv("FREEMUSIC_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FREEMUSIC_TEST_EXPLAIN"] = explain
