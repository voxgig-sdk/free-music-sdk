# FreeMusic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeMusicSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeMusicSDK(...) and FreeMusicSDK.test(...) become
#      FreeMusicSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freemusic_sdk"
_SDK_CLASS = "FreeMusicSDK"
