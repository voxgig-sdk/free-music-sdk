...
class TestV1ListEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        v1_list_ref01_list_result, err = v1_list_ref01_ent.list(v1_list_ref01_match, None)
        assert err is None
        assert isinstance(v1_list_ref01_list_result, list)

        # LOAD
        v1_list_ref01_match_dt0 = {}
        v1_list_ref01_data_dt0_loaded, err = v1_list_ref01_ent.load(v1_list_ref01_match_dt0, None)
        assert err is None
