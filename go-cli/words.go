...
func registerSDKWords(r *eng.Registry, client *sdk.FreeMusicSDK) {
...
func runOp(client *sdk.FreeMusicSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
