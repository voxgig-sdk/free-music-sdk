...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-music` | `npm install @voxgig-sdk/free-music` |
| Python | `voxgig-sdk-free-music` | `pip install voxgig-sdk-free-music` |
| PHP | `voxgig-sdk/free-music` | `composer require voxgig-sdk/free-music` |
| Golang | `github.com/voxgig-sdk/free-music-sdk/go` | `go get github.com/voxgig-sdk/free-music-sdk/go` |
| Ruby | `voxgig-sdk-free-music` | `gem install voxgig-sdk-free-music` |
| Lua | `voxgig-sdk-free-music` | `luarocks install voxgig-sdk-free-music` |
