...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-music-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-sdk/tags) |
| Python | `voxgig-sdk-free-music` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-sdk/tags) |
| PHP | `voxgig-sdk/free-music` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-sdk/tags) |
| Golang | `github.com/voxgig-sdk/free-music-sdk/go` | `go get github.com/voxgig-sdk/free-music-sdk/go@latest` |
| Ruby | `voxgig-sdk-free-music` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-sdk/tags) |
| Lua | `voxgig-sdk-free-music` | publish pending — [install from git tag](https://github.com/voxgig-sdk/free-music-sdk/tags) |
