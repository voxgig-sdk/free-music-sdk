...
func TestV1ListEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		v1ListRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.v1_list")))
...
func v1_listBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FREE_MUSIC_TEST_V1_LIST_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FREE_MUSIC_TEST_V1_LIST_ENTID"])
