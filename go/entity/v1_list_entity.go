...
func NewV1ListEntity(client *core.FreeMusicSDK, entopts map[string]any) *V1ListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V1ListEntity) GetName() string { return e.name }
...
func (e *V1ListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V1ListEntity) Deleted() bool {
	return e.deleted
}


func (e *V1ListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV1ListEntity(e.client, opts)
}

func (e *V1ListEntity) Data(args ...any) any {
...
func (e *V1ListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *V1ListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V1ListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *V1ListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V1ListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V1ListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V1ListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
