...
func NewV2ListEntity(client *core.FreeMusicSDK, entopts map[string]any) *V2ListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V2ListEntity) GetName() string { return e.name }
...
func (e *V2ListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V2ListEntity) Deleted() bool {
	return e.deleted
}


func (e *V2ListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV2ListEntity(e.client, opts)
}

func (e *V2ListEntity) Data(args ...any) any {
...
func (e *V2ListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *V2ListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V2ListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *V2ListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V2ListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V2ListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V2ListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
