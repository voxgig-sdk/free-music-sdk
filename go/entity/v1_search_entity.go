...
func NewV1SearchEntity(client *core.FreeMusicSDK, entopts map[string]any) *V1SearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V1SearchEntity) GetName() string { return e.name }
...
func (e *V1SearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V1SearchEntity) Deleted() bool {
	return e.deleted
}


func (e *V1SearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV1SearchEntity(e.client, opts)
}

func (e *V1SearchEntity) Data(args ...any) any {
...
func (e *V1SearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *V1SearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V1SearchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V1SearchLoadMatch and returns an V1Search. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V1SearchEntity) LoadTyped(reqmatch V1SearchLoadMatch, ctrl map[string]any) (V1Search, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V1Search{}, err
	}
	return typedFrom[V1Search](res), nil
}




func (e *V1SearchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *V1SearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V1SearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V1SearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V1SearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
