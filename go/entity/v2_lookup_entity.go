...
func NewV2LookupEntity(client *core.FreeMusicSDK, entopts map[string]any) *V2LookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V2LookupEntity) GetName() string { return e.name }
...
func (e *V2LookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V2LookupEntity) Deleted() bool {
	return e.deleted
}


func (e *V2LookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV2LookupEntity(e.client, opts)
}

func (e *V2LookupEntity) Data(args ...any) any {
...
func (e *V2LookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V2Lookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V2LookupEntity) DataTyped(data ...V2Lookup) V2Lookup {
	if len(data) > 0 {
		return typedFrom[V2Lookup](e.Data(asMap(data[0])))
	}
	return typedFrom[V2Lookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V2Lookup (all fields
// optional at the wire level).
func (e *V2LookupEntity) MatchTyped(match ...V2Lookup) V2Lookup {
	if len(match) > 0 {
		return typedFrom[V2Lookup](e.Match(asMap(match[0])))
	}
	return typedFrom[V2Lookup](e.Match())
}
...
func (e *V2LookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V2LookupEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V2LookupLoadMatch and returns an V2Lookup. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V2LookupEntity) LoadTyped(reqmatch V2LookupLoadMatch, ctrl map[string]any) (V2Lookup, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V2Lookup{}, err
	}
	return typedFrom[V2Lookup](res), nil
}



func (e *V2LookupEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *V2LookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V2LookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V2LookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V2LookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
