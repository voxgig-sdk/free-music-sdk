...
type V1LookupEntity struct {
	name    string
	client  *core.FreeMusicSDK
...
func NewV1LookupEntity(client *core.FreeMusicSDK, entopts map[string]any) *V1LookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V1LookupEntity) GetName() string { return e.name }
...
func (e *V1LookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V1LookupEntity) Deleted() bool {
	return e.deleted
}


func (e *V1LookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV1LookupEntity(e.client, opts)
}

func (e *V1LookupEntity) Data(args ...any) any {
...
func (e *V1LookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V1Lookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V1LookupEntity) DataTyped(data ...V1Lookup) V1Lookup {
	if len(data) > 0 {
		return typedFrom[V1Lookup](e.Data(asMap(data[0])))
	}
	return typedFrom[V1Lookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V1Lookup (all fields
// optional at the wire level).
func (e *V1LookupEntity) MatchTyped(match ...V1Lookup) V1Lookup {
	if len(match) > 0 {
		return typedFrom[V1Lookup](e.Match(asMap(match[0])))
	}
	return typedFrom[V1Lookup](e.Match())
}
...
func (e *V1LookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V1LookupEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V1LookupLoadMatch and returns an V1Lookup. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V1LookupEntity) LoadTyped(reqmatch V1LookupLoadMatch, ctrl map[string]any) (V1Lookup, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V1Lookup{}, err
	}
	return typedFrom[V1Lookup](res), nil
}




func (e *V1LookupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// V1LookupListMatch and returns []V1Lookup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *V1LookupEntity) ListTyped(reqmatch V1LookupListMatch, ctrl map[string]any) ([]V1Lookup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[V1Lookup](res), nil
}



func (e *V1LookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V1LookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V1LookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V1LookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
