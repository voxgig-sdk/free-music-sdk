...
func NewV2SearchEntity(client *core.FreeMusicSDK, entopts map[string]any) *V2SearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V2SearchEntity) GetName() string { return e.name }
...
func (e *V2SearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V2SearchEntity) Deleted() bool {
	return e.deleted
}


func (e *V2SearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV2SearchEntity(e.client, opts)
}

func (e *V2SearchEntity) Data(args ...any) any {
...
func (e *V2SearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V2Search; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V2SearchEntity) DataTyped(data ...V2Search) V2Search {
	if len(data) > 0 {
		return typedFrom[V2Search](e.Data(asMap(data[0])))
	}
	return typedFrom[V2Search](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V2Search (all fields
// optional at the wire level).
func (e *V2SearchEntity) MatchTyped(match ...V2Search) V2Search {
	if len(match) > 0 {
		return typedFrom[V2Search](e.Match(asMap(match[0])))
	}
	return typedFrom[V2Search](e.Match())
}
...
func (e *V2SearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V2SearchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V2SearchLoadMatch and returns an V2Search. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V2SearchEntity) LoadTyped(reqmatch V2SearchLoadMatch, ctrl map[string]any) (V2Search, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V2Search{}, err
	}
	return typedFrom[V2Search](res), nil
}



func (e *V2SearchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *V2SearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V2SearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V2SearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V2SearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
