...
The Golang SDK for the FreeMusic API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/free-music-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/free-music-sdk=../path/to/github.com/voxgig-sdk/free-music-sdk
```
...
```
github.com/voxgig-sdk/free-music-sdk/
...
The root package (`github.com/voxgig-sdk/free-music-sdk`) re-exports everything needed
